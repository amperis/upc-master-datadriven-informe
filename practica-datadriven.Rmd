...
Los repositorios utilizados para los cálculos y descarga de las fuentes de datos se pueden encontrar en el siguiente reposiorio de Github. En este repositorio puede econtrarse: el script en R para descargar los datos de Shodan, el script para los cálculos intermedios de análisis y los packages dedicados para la práctica.

- https://github.com/amperis/upc-master-datadriven

En el siguiente repositorio puede encontrarse el informe en R de la documentación de la práctica:
...
- Detectar cual es el fabricante con mayor cantidad de vulnerabilidades reportadas en CVE.


# 4. Análisis de datos

A continuación se analizan los países que más dispositivos industriales públicos en Internet se han encontrado a través de Shodan. Como puede observarse el país que más dispositivos tiene con gran diferencia es EEUU:
